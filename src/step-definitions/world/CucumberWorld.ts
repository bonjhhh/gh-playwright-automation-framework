...
export class CucumberWorld extends World {
    ...
    constructor({ attach, log, parameters, link = () => {} }: IWorldOptions) { // Default link to an empty function
        super({ attach, log, parameters, link }); // Pass all options to the World constructor
