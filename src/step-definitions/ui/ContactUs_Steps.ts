...
//Scenario Outlines:
When('I type a first name {word} and a last name {word}', async function (this: CucumberWorld, firstName: string | null | undefined, lastName: string | null | undefined) {

     // Normalize special input cases
     if (firstName === 'null') {
        firstName = null; // Convert "null" string to actual null
    } else if (firstName === 'undefined') {
        firstName = undefined; // Convert "undefined" string to actual undefined
    } else if (firstName === '""') {
        firstName = ""; // Handle the empty string explicitly
    }
    await this.contactUsPage.fillFirstName(firstName);
    ...
    // Normalize special input cases
    if (lastName === 'null') {
        lastName = null; // Convert "null" string to actual null
    } else if (lastName === 'undefined') {
        lastName = undefined; // Convert "undefined" string to actual undefined
    } else if (lastName === '""') {
        lastName = ""; // Handle the empty string explicitly
    }
    await this.contactUsPage.fillLastName(lastName);
});
